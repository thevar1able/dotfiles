...
require('lazy').setup({
  ...
  { 'lukas-reineke/indent-blankline.nvim', main = 'ibl', scope = { enabled = true }, opts = { indent = { char = '┊' } } }, -- Add indentation guides even on blank lines
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'typescript', 'vim', 'bash' },
